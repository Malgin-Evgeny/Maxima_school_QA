...
public class MainPageTest {
    ...
    public void clickButtonMainPage() {
        SelenideElement mainPageButton = $(By.xpath("//*[@id=\"n-mainpage-description\"]"));
    ...
    public void clickButtonContent() {
        SelenideElement buttonContent = $(By.xpath("//*[@id=\"n-content\"]"));
        buttonContent.click();
        Assert.assertEquals(Selenide.webdriver().driver().url(),
    ...
    public void clickButtonFavorites() {
        SelenideElement buttonFavorites = $(By.xpath("//*[@id=\"n-featured\"]/a/span"));
